...
do
    ...
    -ldflags "\
        -w \
        -X 'github.com/grafana/influx2cortex/pkg/appcommon.CommitUnixTimestamp=${COMMIT_UNIX_TIMESTAMP}' \
        -X 'github.com/grafana/influx2cortex/pkg/appcommon.DockerTag=${DOCKER_TAG}' \
        " \
