...
import (
	...
	"github.com/grafana/influx2cortex/pkg/util/push"

	"github.com/grafana/influx2cortex/pkg/appcommon"
...
type Client interface {
	Write(ctx context.Context, req *cortexpb.WriteRequest) error
}
...
func NewClient(cfg Config, metricsRecorder Recorder, tripperware Tripperware) (Client, error) {
...
func (c *client) Write(ctx context.Context, req *cortexpb.WriteRequest) error {
